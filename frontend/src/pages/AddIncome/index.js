...
class AddIncome extends Component {
  ...
  handleCreateIncome = () => {
    ...
    if (!this.state.stop_request) {
      ...
      api.post('/incomes', { date, description, value: parseFloat(value), category_id })
        .then(response => {
          NotificationManager.success(null, 'A Receita foi cadastrada com sucesso');
          this.setState({ 
            entry_date: '',
            entry_value: '',
            entry_description: '',
